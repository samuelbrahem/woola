      ...
      <div className="container-x pt-20 md:pt-28 pb-20 relative">
        <div className="grid lg:grid-cols-12 gap-12 items-end">
          <div className="lg:col-span-7">
            <div className="eyebrow rise">{site.tagline}</div>
            <h1 className="rise rise-1 mt-5 text-5xl md:text-6xl lg:text-7xl font-bold leading-[0.98] tracking-tight text-ink-800">
              A people-focused
              <br />
              property services
              <br />
            ...
            <div className="rise rise-4 mt-10 flex flex-wrap items-center gap-x-8 gap-y-4 text-sm text-ink-500">
          ...
          <div className="lg:col-span-5">
            <div className="rise rise-3 bg-ink-800 text-cream-50 rounded-md p-8 relative overflow-hidden">
              <div className="grain" />
